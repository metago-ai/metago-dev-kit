...
来自 `metago-lifeform@>=36.4.13`，开发者场景下高频调用：
...
必须先安装 [MetaGO Lifeform Kit](https://gitee.com/metago/metagolifeform) v36.4.13 或更高版本：
...
- **依赖**：`metago-lifeform@>=36.4.13`（peerDependency）
- **许可证**：MIT
